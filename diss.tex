...
%% 各章正文内容
\include{body/chapter001}
\include{body/chapter002}
\include{body/chapter003}
\include{body/chapter004}
\include{body/chapter005}
...
% 使用 BibTeX
% 包含参考文献文件.bib
\bibliography{reference/chap1,reference/chap2,reference/chap4}
